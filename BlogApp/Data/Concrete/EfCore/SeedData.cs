            ...
            if(context != null){
                ...
                if(!context.Users.Any()){
                    context.Users.AddRange(
                        new User{UserName = "ahmetkaya", Name="Ahmet Kaya", Email = "info@ahmetkaya.com",Password="123456,", Image = "images.jpg"},
                        new User{UserName = "sinankarabulut", Name="Sinan Karabulut", Email = "info@sinan.com",Password="123456,", Image = "images.jpg"}
                    );
                    context.SaveChanges();
                }
